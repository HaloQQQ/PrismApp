...
namespace MauiAppNet8.ViewModels
{
    ...
    {
        private string _colorCode = "#5542b983";
        ...
        public Color ContrastColor => Color.FromArgb(ContrastColorCode);
        ...
        public Brush Background => Color.FromArgb(this.ColorCode);
        ...
        public class ColorModel
        {
            public ColorModel(string colorCode)
            {
                ...
                this.Background = Color.FromArgb(colorCode);

                this.Foreground = Color.FromRgb(
                        255 - Convert.ToByte(colorCode.Substring(1, 2), 16),
                        255 - Convert.ToByte(colorCode.Substring(3, 2), 16),
                        255 - Convert.ToByte(colorCode.Substring(5, 2), 16)
                    );
            }
