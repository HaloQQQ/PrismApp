...
{
    internal class _2048ViewModel : BaseNotifyModel
    {
        public _2048ViewModel(IEventAggregator eventAggregator, IConfigManager configManager)
        {
