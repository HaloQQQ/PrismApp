...
{
    public partial class VerticalMusicLyricDesktopWindow : Window
    {
        public VerticalMusicLyricDesktopWindow(IConfigManager configManager)
        {
            InitializeComponent();
            ...
            bindings.Converter = new VerticalDesktopLyricMultiConverter();
        ...
        protected override void OnClosed(EventArgs e)
        {
            ...
            _configManager.WriteConfigNode(string.Join(",", new double[] { this.Left, this.Top }), new string[] { "Music", "Vertical_DesktopLyric_WindowLeftTop" });
        }
